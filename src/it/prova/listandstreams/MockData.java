...
PostaDiPaese postaDiOrte = new PostaDiPaese("PostaNazionale", "via dei gigli 86", dataOpen, 50);
...
PostaDiPaese postaDiOrvieto = new PostaDiPaese("PostaUmbra", "via dei bersaglieri 98", dataOpen1, 68);
