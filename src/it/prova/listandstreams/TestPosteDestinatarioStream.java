...
public class TestPosteDestinatarioStream {
...
// con numero dipendenti compreso tra 50 e 100;
		...
		System.out.println(
				"I destinatari che hanno un conto e appartenenti a uffici postali con numero dipendenti compreso tra 50 e 100 sono: ");
		destinatariConContoCorrenteEPosteConDipendentiTra50e100
				.forEach(destinatario -> System.out.println(destinatario.getNome() + " " + destinatario.getCognome()));
